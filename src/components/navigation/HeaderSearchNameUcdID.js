...
@observer
class HeaderSearchNameUcdID extends Component {
      ...
      <View style={styles.searchInputContainer}>
        ...
        {distributorSearchHeader && (
          <View style={styles.headerContainer}>
            ...
            <View style={styles.searchContainer}>
              <TextInput
                ...
                onChangeText={value => {
                  ...
                  }else if (isSpecialCharacterValidator(value)) {
                    setTimeout(
                      () =>
                        showToast(
            ...
            {(this.checkIsString(this.searchValue)&&this.searchValue.trim().length<3)?
            (  <Text style={[styles.submitTextStyle, { opacity: 0.4 }]}>
              {this.props.submitButtonText}
            </Text>):(this.checkIsString(this.searchValue)&& this.searchValue.trim().length>=3)
            ?(
             <TouchableOpacity
                onPress={() => {
                  Keyboard.dismiss();
                  ...
                  if (this.searchValue.trim() == '11000001') {
                    ...
                    if (this.props.submitButtonText === 'Validate') {
                      ...
                      this.props.network.fetchSearchDataByUcdNameSearch(
                        this.searchValue,
                        this.props.submitButtonText,
                      );
                    }
            ...
            :(!this.checkIsString(this.searchValue) && this.searchValue.trim().length < 8 ) ? (
              <Text style={[styles.submitTextStyle, { opacity: 0.4 }]}>
                {this.props.submitButtonText}
              </Text>
            ) : (
...
export default HeaderSearchNameUcdID;
