  ...
  */
  ...
  renderTopControls() {
    ...
    return (
      <Animated.View
        ...
        <ImageBackground
          source={require('../../assets/images/video_controls/top-vignette.png')}
  ...
  renderBack() {
    return this.renderControl(
      <Image
        source={require('../../assets/images/video_controls/back.png')}
      ...
      <View style={styles.volume.container}>
        ...
        <View
          ...
          <Image
            ...
            source={require('../../assets/images/video_controls/volume.png')}
          />
        </View>
      </View>
    );
  ...
  renderFullscreen() {
    let source =
      this.state.isFullscreen === true
        ? require('../../assets/images/video_controls/shrink.png')
        : require('../../assets/images/video_controls/expand.png');
    return this.renderControl(
      <Image source={source} />,
      this.methods.toggleFullscreen,
  ...
  renderBottomControls() {
    ...
    return (
      <Animated.View
        ...
        <ImageBackground
          source={require('../../assets/images/video_controls/bottom-vignette.png')}
          style={[styles.controls.column]}
          imageStyle={[styles.controls.vignette]}>
          {seekbarControl}
          <View
  ...
  renderPlayPause() {
    let source =
      this.state.paused === true
        ? require('../../assets/images/video_controls/play.png')
        : require('../../assets/images/video_controls/pause.png');
    return this.renderControl(
      <Image source={source} />,
    ...
    if (this.state.loading) {
      return (
        <View style={styles.loader.container}>
          <Animated.Image
            source={require('../../assets/images/video_controls/loader-icon.png')}
            style={[
              styles.loader.icon,
              {
                transform: [
    ...
    if (this.state.error) {
      return (
        <View style={styles.error.container}>
          <Image
            source={require('../../assets/images/video_controls/error-icon.png')}
